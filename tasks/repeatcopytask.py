...
def dataloader(num_batches,
    ...
    This crette a random batches of "bits" sequences.
    ...
    for batch_num in range(num_batches):
        ...
        # number pf reps and sequence lenghth in same for all
        ...
        # 2 additional channels in the input, for end-of-sequence and num-reps
